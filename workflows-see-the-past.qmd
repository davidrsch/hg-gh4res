# Time travel: See the past {#sec-time-travel-see-past}
...
From your repo's landing page, access commit history by clicking on "xyz commits". This is like using `git log` locally, but much more rewarding. If you have a good [local Git client](sec-git-client), it probably also provides a graphical overview of history.

![Link to commit listing on GitHub.](img/screenshots/github-link-to-commits.png){width="100%"}
...
![Example of a commit listing on GitHub.](img/screenshots/github-commit-listing.png){width="100%"}
...
![Visiting a specific file on GitHub.](img/screenshots/github-specific-file.png){width="100%"}
...
![Typing into GitHub search bar.](img/screenshots/github-repo-search.png){width="100%"}
