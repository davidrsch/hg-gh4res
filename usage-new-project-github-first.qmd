# New project, GitHub first {#sec-new-github-first}
...
You've actually done this before during set up (chapter sec-rstudio-git-github). We're doing it again, *with feeling*.
...
## New RStudio Project via git clone {#sec-new-rstudio-project-via-git}
