# Make a GitHub repo browsable {#sec-workflows-browsability}
...
You can then click on "Knit" then "Knit to github document" to perform the conversion. See [Output format](##%20Output%20format) for more details of controlling output formats with the YAML frontmatter.
