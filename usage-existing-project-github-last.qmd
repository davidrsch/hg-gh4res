# Existing project, GitHub last {#sec-existing-github-last}

This an explicit workflow for connecting an existing local R project to GitHub, when for some reason you cannot or don't want to do a "GitHub first" workflow (see chapters sec-new-github-first) and sec-existing-github-first).
