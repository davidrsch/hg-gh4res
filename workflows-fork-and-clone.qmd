...
Estos pasos le facilitan mantenerse actualizado con los desarrollos en el repositorio de origen. Hablamos más a continuación sobre por qué nunca debes comprometerte con la rama predeterminada, p. `main`, cuando estás trabajando en una bifurcación (ver @sec-fork-dont-touch-main).
...
Para obtener más detalles, estas preguntas y respuestas sobre Stack Overflow son útiles: [¿Por qué es una mala práctica comprometerse con la rama maestra de su bifurcación?](https://stackoverflow.com/q/33749832).
