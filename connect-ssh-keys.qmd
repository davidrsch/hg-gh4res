...
-   If you are new to programming and the shell, you'll probably find HTTPS easier at first (@sec-https-pat). You can always switch to SSH later. You can use one method from computer A and the other from computer B.
