...
-   You've registered a free GitHub account (@sec-github-acct).
-   You've installed/updated R and RStudio (@sec-install-r-rstudio).
-   You've installed Git (@sec-install-git).
-   You've introduced yourself to Git (@sec-hello-git).
-   You've confirmed that you can push to / pull from GitHub from the command line (@sec-push-pull-github).
