...
Una vez que tenemos nuestras credenciales ordenadas, en [Conectar a GitHub](#sec-push-pull-github), usamos Git en el shell para asegurarnos de que pueda clonar un repositorio desde GitHub y establecer comunicaciones bidireccionales, es decir, extraer y enviar.
