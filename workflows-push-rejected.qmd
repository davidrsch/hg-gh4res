# Dealing with push rejection {#sec-push-rejected}
...
This is covered in the workflow [Pull, but you have local work](#sec-pull-tricky).
...
Let's think about your commit `D`. Maybe it was built up over a couple of days via the [Repeated Amend pattern](#sec-repeated-amend). Maybe `C` was sitting there on GitHub the whole time or appeared very early in your process.
...
Finally, your early experiences collaborating with others and yourself in `main` will give you a visceral understanding of why most Git users eventually start to use [branches](#sec-git-branches).
